...
import io.stibits.config.audit.AuditEventConverter;
import io.stibits.domain.PersistentAuditEvent;
...
import static io.stibits.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
