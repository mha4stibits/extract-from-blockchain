...
describe('Service Tests', () => {
    describe('Block Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Block(0, 0, 'AAAAAAA', 'AAAAAAA', 0, 0, 0, 0, 0, 0, 'AAAAAAA', 0, 'AAAAAAA', currentDate, false);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Block', async () => {
                const returnedFromService = Object.assign(
                    {
                        version: 1,
                        previousBlockHash: 'BBBBBB',
